defmodule SymphonyElixir.WorkspaceAndConfigTest do
  ...
  test "config reads defaults for optional settings" do
    ...
    write_workflow_file!(Workflow.workflow_file_path(), codex_command: "codex --config model_reasoning_effort=high --model gpt-5.4 app-server")
    assert Config.settings!().codex.command == "codex --config model_reasoning_effort=high --model gpt-5.4 app-server"
